...
An unlimited number of crucibles can be created. Please note if you visit etherscan \(link to etherscan\) please disregard the word "Max" in "Max Total Supply" because the supply is unlimited. The "Max Total Supply" shown on etherscan just indicates the current number crucibles created so far.

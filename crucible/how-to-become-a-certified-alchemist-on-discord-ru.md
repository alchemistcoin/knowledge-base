...
Если ваш Crucible был создан с помощью [Alchemist.farm](https://alchemist.farm/), переходите ко **2й части данной инструкции.** 

Если ваш Crucible был создан с помощью [командной строки](https://github.com/alchemistcoin/alchemist), то вам сперва надо войти в MetaMask используя мнемоническую фразу, которую вы получили во время создания Crucible. Подробные инструкции указаны в [**1й части инструкции ниже.**](https://app.gitbook.com/@alchemist-docs/s/mist/v/russian/crucible/how-to-become-a-certified-alchemist-on-discord-ru#1-chast)\*\*\*\*
